...
export const GETTING_STARTED_STEPS = [
  ...
  },
  {
    ...
    hint: 'Create a new directory called <code>me</code> in <code>src/routes</code>. Within this directory create a <code>index.tsx</code> file or copy the <code>src/routes/index.tsx</code> file. Your new route is now accessible <a href="/me" target="_blank">here</a> â¨',
  },
  {
    message: 'Time to have a look at <b>Forms</b>',
    hint: 'Open <a href="/demo/todolist" target="_blank">the TODO list App</a> and add some items to the list. Try the same with disabled JavaScript ð°',
  },
  {
    message: '<b>Congratulations!</b> You are now familiar with the basics! ð',
